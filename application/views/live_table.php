...
<script>
    $(document).ready(function () {
        ...
        // alertify.success('Data successfully deleted','bottom');
        ...
        $(document).on('click', '.btn_delete', function () {
            var id = $(this).attr('id');
           alertify.confirm('Delete Data', 'Do you want to delete data?', function () {
                   $.ajax({
                       ...
                       success: function (data) {
                           load_data();
                           alertify.success('Data successfully deleted','bottom-right');
                       },
                       error:function () {
